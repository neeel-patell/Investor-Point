...
import in.weareindian.investorapp.adapters.BlogAdapter;
...
public class BlogFragment extends Fragment {
    ...
    String blogId, imageUrl, blogSubject, blogDescription, time;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        rvBlogPost.addOnScrollListener(new RecyclerView.OnScrollListener() {
    ...
    private void getMoreData() {
        progressBarBlog.setVisibility(View.VISIBLE);
        limit = limit +20;
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    for(int i = 0; i<jsonArray.length(); i++)
                                    {
                                        ...
                                        blogId = object.getString("id");
                                        imageUrl = object.getString("images");
                                        blogSubject = object.getString("subject");
                                        blogDescription = object.getString("description");
                                        time = object.getString("time");

                                        Blog temp = new Blog(blogId, imageUrl, blogSubject, blogDescription, time);
                                        list.add(temp);
                                    }

                                    adapter.notifyDataSetChanged();
                                    progressBarBlog.setVisibility(View.GONE);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            rvBlogPost.setAdapter(adapter);
                            rvBlogPost.setLayoutManager(manager);
                            progressBarBlog.setVisibility(View.GONE);
    ...
    private void Init() {
        rvBlogPost = root.findViewById(R.id.rvBlogPost);
        manager = new LinearLayoutManager(getContext());
        progressBarBlog = root.findViewById(R.id.progressBarBlog);
        list = new ArrayList<>();
