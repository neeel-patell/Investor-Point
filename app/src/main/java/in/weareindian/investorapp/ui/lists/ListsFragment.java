...
public class ListsFragment extends Fragment {
    // This is others fragment
    private ListsViewModel mViewModel;
    View root;
    RecyclerView rvListsPost;
    LinearLayoutManager manager;
    ProgressBar progressBarLists;
    ...
    int limit = 0;
    String category = Integer.toString(5);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root = inflater.inflate(R.layout.lists_fragment, container, false);
        context = getActivity();
        ...
        rvListsPost.addOnScrollListener(new RecyclerView.OnScrollListener() {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            rvListsPost.setAdapter(adapter);
                            rvListsPost.setLayoutManager(manager);
                            progressBarLists.setVisibility(View.GONE);
    ...
    private void Init() {
        rvListsPost = root.findViewById(R.id.rvListsPost);
        manager = new LinearLayoutManager(getContext());
        progressBarLists = root.findViewById(R.id.progressBarLists);
        list = new ArrayList<>();
