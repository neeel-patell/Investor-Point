...
public class PrimeFragment extends Fragment {
    ...
    View root;
    RecyclerView rvPrimePost;
    LinearLayoutManager manager;
    ProgressBar progressBarPrime;
    ...
    int limit = 0;
    String category = Integer.toString(4);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root = inflater.inflate(R.layout.prime_fragment, container, false);
        context = getActivity();
        ...
        rvPrimePost.addOnScrollListener(new RecyclerView.OnScrollListener() {
    ...
    private void getMoreData() {
        progressBarPrime.setVisibility(View.VISIBLE);
        limit = limit +20;
                        ...
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    progressBarPrime.setVisibility(View.GONE);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            rvPrimePost.setAdapter(adapter);
                            rvPrimePost.setLayoutManager(manager);
                            progressBarPrime.setVisibility(View.GONE);
    ...
    private void Init() {
        rvPrimePost = root.findViewById(R.id.rvPrimePost);
        manager = new LinearLayoutManager(getContext());
        progressBarPrime = root.findViewById(R.id.progressBarPrime);
        list = new ArrayList<>();
